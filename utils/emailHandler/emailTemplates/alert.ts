                ...
                <tr>
                  <td>
                    ...
                    <div style="text-align: center; margin-bottom: 20px;">
                      <h2 style="color: #ff0f0f; font-size: 20px; font-weight: 600; margin: 0;">Warning:Low coupon</h2>
                    </div>
                    <div style="text-align: center; margin-bottom: 20px;">
                      <p style="color: #001044; font-size: 14px; font-weight: 400; margin: 0;">The remaining available coupons are ${availableCount}.</p>
                    </div>
                  </td>
                </tr>
                <tr>
